...
def main():
    ...
    ## parseSTARFusion
    parser_parse_star_fusion = subparsers.add_parser(
    ...
    parser_parse_star_fusion.add_argument(
        '-f', '--fusion',
        type=str,
    ...
    parser_parse_star_fusion.set_defaults(func=cli.parse_star_fusion)


    ## parseFusionCatcher
    parser_fusion_catcher = subparsers.add_parser(
    ...
    parser_fusion_catcher.add_argument(
        '-f', '--fusion',
        type=str,
    ...
    parser_fusion_catcher.set_defaults(func=cli.parse_fusion_catcher)

    ## parser_rmats
    parser_rmats = subparsers.add_parser(
        name='parseRMATS',
    ...
    parser_rmats.set_defaults(func=cli.parse_rmats)
