...
def call_variant_peptide(args:argparse.Namespace) -> None:
    ...
    with seqvar.VariantRecordPoolOnDiskOpener(caller.variant_record_pool) as pool:
        ...
        if caller.process_all_transcripts:
            tx_sorted = list(ref.anno.transcripts.keys())
        else:
        ...
        for tx_id in tx_sorted:
            ...
            if variant_series.is_empty() and not caller.process_all_transcripts:
                continue
            ...
            dispatch = (
                ...
                caller.process_all_transcripts, caller.check_external_variants
            )
...
def call_peptide_fusion(variant:seqvar.VariantRecord,
        ...
        w2f_reassignment:bool, check_external_variants:bool
        ) -> Set[aa.AminoAcidSeqRecord]:
...
def call_peptide_circ_rna(record:circ.CircRNAModel, ref:params.ReferenceData,
    ...
    return pgraph.call_variant_peptides(
        ...
        w2f=w2f_reassignment, check_external_variants=check_external_variants
    )
