...
from moPepGen.cli.common import add_args_cleavage, add_args_input_path, add_args_output_path, add_args_quiet, \
    print_start_message, print_help_if_missing_args, add_args_reference, \
    load_references, validate_file_format
...
def add_subparser_call_variant(subparsers:argparse._SubParsersAction):
    ...
    p.add_argument(
        ...
        type=Path,
        nargs='+',
        help='File path to input variant files. Must be generated by any of the'
        ' moPepGen parser. Can take multiple files. Valid file type: ".gvf"',
        metavar='<files>',
        required=True
    )
    add_args_input_path(
...
class VariantPeptideCaller():
    ...
    def __init__(self, args:argparse.Namespace):
        ...
        validate_file_format(self.output_path, OUTPUT_FILE_FORMATS)
